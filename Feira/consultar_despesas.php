<?php
   ...
   $sql = "SELECT CodDespesa, ValorDesp, Descricao, TipoDaDespesa, Ano, Dia, Mes, StatusDespesa FROM despesa WHERE CodUsuario = $codUsuario AND CodStatus = 1";
		...
		<div class="container app mt-5">
			<table class="table">
				...
				<tbody class="bg-white">
					...
					<td><? echo $dado['Descricao'] ?> (<? echo $dado['StatusDespesa'] ?>)</td>
					<td><? echo $dado['ValorDesp'] ?></td>
					<td><a href="#" class="fas fa-check" style="color: black"></a></td>
					<td><a href="#" id="excluir" class="fas fa-trash-alt" style="color: black"></a></td>
					</tr>
				</tbody>
				<?php } ?>
			</table>
