...
<html>
  <head>
    ...
    <style>
        ...
        .caixa-texto_quemSomos{
            ...
            box-shadow: 23px 26px 150px -100px rgba(53, 56, 56, 1);
        }
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
    ...
    <div class="container-fluid  h-100 block" id="quemSomosFundo" style="background-color: #1B1B1B!important">    
            ...
            <h3 class="py-3 text-center"> <font face="courier" size="7" color="#FFFFFF">Quem somos ?</font></h3>
