<?php
   ...
   $sql = "SELECT CodDespesa, ValorDesp, Descricao, TipoDaDespesa, Ano, Dia, Mes, StatusDespesa FROM despesa WHERE CodUsuario = $codUsuario";
		...
		<div class="container app mt-5">
			<table class="table">
				...
				<tbody class="bg-white">
					<tr>
					<!--<td scope="row"><? //echo $dado['TipoDaDespesa']?></td>-->
					<td scope="row"><? echo $dado['Descricao'] ?> (<? echo $dado['StatusDespesa'] ?>)</td>
					<td><? echo $dado['ValorDesp'] ?></td>
					<td><i class="fas fa-check" style="color: white"></i></td>
					<td><a href="remove.php?id=<? echo $dado['CodDespesa'] ?>" class="fas fa-trash-alt" style="color: black"></a></td>
					</tr>
				</tbody>
				<?php } ?>
			</table>
